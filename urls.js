...
module.exports = [
	{
		...
		radios: [
			...
			{ name: "Radio 1", url: "https://services.vrt.be/playlist/onair?channel_code=11&accept=application%2Fvnd.playlist.vrt.be.noa_1.0%2Bjson", parser: "Belgium/MNM" },
			{ name: "Studio Brussel", url: "https://services.vrt.be/playlist/onair?channel_code=41&accept=application%2Fvnd.playlist.vrt.be.noa_1.0%2Bjson" },
			{ name: "RTBF La Première", url: "http://np.maradio.be/qp/v3/events?rpId=1103" },
			{ name: "Zen FM", url: "https://zenfm.be/wp-admin/admin-ajax.php" },
		]
	},
	{
		country: "France",
